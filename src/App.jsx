...
import Pointage from './pages/Pointage'   // ✅ NOUVEAU
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <main className="ml-60 flex-1">
        ...
        {activePage === 'pointage'        && <Pointage onNavigate={setActivePage} />}  {/* ✅ NOUVEAU */}
      </main>
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-4 flex items-start gap-3 max-w-sm">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${notification.color}`}>Nouvelle {notification.type}</span>
              </div>
